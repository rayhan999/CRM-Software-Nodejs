...
const customer2				= require('./controller/manager/customer');
const employee				= require('./controller/manager/employee');
const leads			   = require('./controller/manager/leads');
const product2		= require('./controller/manager/product');
const eventinfo	     = require('./controller/manager/eventinfo');
const app 					= express();
